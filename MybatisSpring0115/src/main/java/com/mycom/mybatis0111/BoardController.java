...
public class BoardController {
	...
	public String boardDetail(String boardseq, Model model) {
		...
		ArrayList<Comments> cList = dao.commentsList(boardseq);
	...
	//댓글 등록하기
		...
		public String deleteComments(HttpSession session, Comments comments, String boardseq, Model model) {
			if (session.getAttribute("loginId") == null) {//로그인 session이 만료되지 않았는지 session검사
				return "login";
			}
